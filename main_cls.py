''' 将DisenGCN的方法使用在利用Item的邻居关系构建的Global Item Context图上
    DisenGCN论文: Disentangled Graph Convolutional Networks (2019, ICML)
    待整理代码
'''
import os
import argparse
...
'''模型超参数'''
parser.add_argument('--n_factors', type=int, default=40)
